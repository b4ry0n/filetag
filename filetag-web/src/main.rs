...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        ...
        .route("/css/chat.css", get(api::css_chat))
        ...
        .route("/api/fs/rename", post(api::api_fs_rename))
        ...
        .route("/api/trash/delete", post(api::api_trash_delete))
        .route("/api/trash/empty", post(api::api_trash_empty))
        ...
        .route("/api/jobs/stream", get(api::api_jobs_stream))
        .route("/api/jobs/{id}", delete(api::api_jobs_dismiss))
        .route("/api/jobs/{id}/cancel", post(api::api_jobs_cancel))
        ...
        .route("/api/prune-tags", post(api::api_prune_tags))
        .route("/api/create-subject", post(api::api_create_subject))
        .route("/api/rename-subject", post(api::api_rename_subject))
        ...
        .route(
            "/api/subject/remove-prop",
            post(api::api_subject_remove_prop),
        )
        .route("/api/synonym/add", post(api::api_add_synonym))
        .route("/api/synonym/remove", post(api::api_remove_synonym))
        .route("/api/synonym/attr", post(api::api_set_tag_attr))
        .route("/api/synonym/attr-remove", post(api::api_remove_tag_attr))
        .route("/api/display-context", get(api::api_get_display_context))
        .route("/api/display-context", post(api::api_set_display_context))
